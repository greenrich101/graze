...
// Roma's CDN actively blocks Chrome-style UAs but serves cleanly with no UA.
// Dalby's listing page does the inverse (403 with no UA). So PDFs go bare,
// the Dalby HTML scrape uses UA.
...
function parseAgriNous(text: string, saleDate: string): SaleResult | null {
  ...
  // Numbers may have decimals (e.g. "94.20"); allow . in the captures
