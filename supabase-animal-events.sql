-- Animal Events: sold/deceased tracking
-- Run this after existing schema migrations

-- ============================================================
-- 1. Create animal_events table
-- ============================================================
...
-- ============================================================
-- 3. RLS Policies (property-based access via mob relationship)
-- ============================================================
...
-- ============================================================
-- 6. Create RPC function for atomic log + composition update
-- ============================================================
...
-- Usage examples:
-- ============================================================
-- Log sale:      SELECT log_animal_event('Mob A', 'sold', 'cow', 2, '2026-02-05', 'Sold to XYZ Farm');
-- Log death:     SELECT log_animal_event('Mob A', 'deceased', 'calf', 1, '2026-02-05', 'Found dead in paddock');
-- Without notes: SELECT log_animal_event('Mob A', 'sold', 'bull', 1, '2026-02-05');
